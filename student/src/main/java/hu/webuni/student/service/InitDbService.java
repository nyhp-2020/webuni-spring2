...
//		Course course4 = Course.builder().name("Informatika").build();
		...
		Student student2 = Student.builder().name("Ladó Béla").birthdate(LocalDate.of(1992, 3, 15)).semester(1).build();
		Student student3 = Student.builder().name("Szél Kálmám").birthdate(LocalDate.of(1983, 9, 11)).semester(2).build();
		Student student4 = Student.builder().name("Arató Dávid").birthdate(LocalDate.of(194, 11, 5)).semester(2).build();

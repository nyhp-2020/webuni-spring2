...
create table university_user_aud (id int8 not null, rev int4 not null, revtype int2, birthdate date, facebook_id varchar(255), name varchar(255), password varchar(255), username varchar(255), primary key (id, rev));
create table university_user (id int8 not null, birthdate date, facebook_id varchar(255), name varchar(255), password varchar(255), username varchar(255), primary key (id));
